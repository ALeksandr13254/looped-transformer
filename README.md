...
Для обучения была использована реализация из оригинальной статьи https://github.com/leiay/looped_transformer, но с уменьшением числа шагов обучения и размерности регрессии. Также в конфиг модели были добавлены параметры model.n_last_tokens и model.use_lstm_layer
